...
## Bernoulli trial
The probability of exactly k successes in trials
$C(n,k)$ the probability of $n$ successes in $k$ attempts. 
$C(n,k) = \frac{n \times (n-1) \times \ldots \times (n-k+1)}{1 \times 2 \times \ldots \times k} = \frac{n!}{k! (n-k)!}$
